...
from models.ST_Former_DFER import *
import matplotlib.pyplot as plt
import numpy as np
import datetime
from distutils.dir_util import copy_tree
from dataloader.dataset_AFEW import image_train_data_loader, image_test_data_loader
...
# pretrained_checkpoint_path = './checkpoint/resnet18_transformer_3_8_balanced.pth'
...
def main():
    ...
    # model = GenerateModel()
    model = Model('D:\project\Former-DFER-main\Former-DFER-main_AFEX\checkpoint/resnet50_ft_weight.pkl')
    ...
    # Data loading code
    train_data = image_train_data_loader()
    test_data = image_test_data_loader()
